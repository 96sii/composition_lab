...
class TestBand(unittest.TestCase):
    ...
    def setUp(self):
        self.guitarist = Guitarist("Steve Marker", 100000, 0)
        self.bassist = Bassist("Duke Erikson", 5000, 0)
    ...
    def test_band_can_calculate_payroll(self):
        self.assertEqual(195000, self.band.calculate_payroll(self.musicians))
    
    def test_band_can_pay_salaries(self):
        old_bank = self.guitarist.get_bank()
        self.band.pay_salaries(self.musicians)
